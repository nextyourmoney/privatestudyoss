...
<div class="card m-2">
   ...
   <div class="card-body">
      ...
      <div class="card m-2">
         ...
         <script>
            function requestGet() {
            	/*form1 이라는 name의 param1이라는 name의 값을 가져온다. */
               const param1 = document.form1.param1.value;
            	//param2라는 아이디를 가진 값을 가져온다.
               const param2 = document.querySelector("#param2").value;
      			//jquery를 사용하여 가져온다.
               const param3 = $("#param3").val();
      			//form1이라는 name을 가진 값에서 name이parma4라는 값중 checked된 값을 가져온다.
      ...
      <div class="card m-2">
         ...
         <div class="card-body">
         		<a href = "method3?param1=문자열1&param2=5"> 요청</a>
         </div>
     ...
     <div class="card m-2">
         ...
         <div class="card-body">
         		 <form method="get" action="method5">
               <div class="input-group">
                  <div class="input-group-prepend"><span class="input-group-text">param1</span></div>
                  <input type="text" name="param1" class="form-control" value="문자열">
               </div>
